...
const AnimatedAICircle = ({ className = '' }: AnimatedAICircleProps) => {
  return (
    <div className={`relative w-48 h-48 max-w-xs aspect-square rounded-full border-4 border-green-500 shadow-lg flex items-center justify-center ${className}`}>
      <div className="relative w-full h-full m-1 rounded-full border-4 border-blue-500 shadow-lg flex items-center justify-center">
        ...
        <div className="flex flex-col items-center z-2">
          <span className="relative p-2 md:p-4 text-center text-sm md:text-xl lg:text-xl font-semibold bg-gradient-to-r from-green-400 to-blue-500 animate-[pulse_1s_linear_infinite] bg-clip-text text-transparent">
            AI Powered
          </span>
          <span className="relative p-2 md:p-4 text-center text-sm md:text-xl lg:text-xl font-semibold bg-gradient-to-l from-green-400 to-blue-500 animate-[pulse_5s_linear_infinite] bg-clip-text text-transparent">
            Active Knowledge
          </span>
        </div>
        <div
