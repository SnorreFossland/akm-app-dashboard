...
export function ModeSwitcher({ currentMode, onModeChange, onOpenAIChat, aiChatOpen }: ModeSwitcherProps) {
    return (
        <div className="flex items-center gap-2 w-full">
            ...
            <div className="flex gap-1 bg-gray-500/50 p-0.5 rounded ml-auto">
                <button
                    onClick={() => {
                        if (typeof (onOpenAIChat as any) === 'function') {
                            (onOpenAIChat as () => void)();
                            return;
                        }
                        onModeChange('chat');
                    }}
