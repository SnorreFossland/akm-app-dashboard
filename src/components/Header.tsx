...
const ModelHeader: React.FC<ModelHeaderProps> = ({ metisName }) => {
    return (
        <header className="m-2 me-auto w-full bg-blue-500/60 text-gradient-to-r from-green-700 to-blue-900 text-transparent bg-clip-text">
            <div className="flex justify-between items-center font-bold text-white text-green-500 mx-5">
                <div className="me-5 mb-0 mt-4 text-muted-foreground">Domain file :
