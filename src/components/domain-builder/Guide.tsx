...
const Guide: React.FC = () => {
    return (
        <div className="flex flex-col gap-2">
            ...
            <div className="p-4 border border-gray-700 rounded-lg bg-secondary/90">
                <h3 className="text-lg font-medium text-secondary-foreground/70">Step 3: Save Your Domain</h3>
                <div className="text-sm text-secondary-foreground/60 mt-1">
            ...
            <div className="p-4 border border-gray-700 rounded-lg bg-secondary/90">
                ...
                <div className="text-sm text-secondary-foreground/60 mt-1">
                    Check the <span className="text-blue-400 font-semibold">'Current Domain'</span> tab to see the generated domain details. Use the AI chat to refine the definition.
                </div>
            </div>
        </div>
    )
