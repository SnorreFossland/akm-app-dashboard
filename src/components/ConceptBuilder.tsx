...
const ConceptBuilder = ({ topicDescr, settopicDescr, isLoading, handleFirstStep, concepts, setStep }) => (
    <Card>
        <CardHeader>
        ...
        <CardContent>
            ...
            <Textarea
                ...
                rows={3}
            />
            {/* Additional fields and logic for domain description and concepts */}
        </CardContent>
        <CardFooter>
            <div className="flex justify-between">
                <Button onClick={() => { setStep(1); handleFirstStep(); }} className={`rounded text-xl p-4 ${(concepts.length > 0) ? 'bg-green-900 text-white' : 'bg-green-700 text-white'}`}>
